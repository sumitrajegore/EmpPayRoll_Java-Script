...
try{
    let employeePayrollData3=new EmployeePayrollData(2,"Terrisa",30000,"F",new Date());
...
try{
    let employeePayrollData4=new EmployeePayrollData(3,"Terrisa",30000,"X",new Date());
...
try{
    let employeePayrollData5=new EmployeePayrollData(4,"Terrisa",30000,"F",new Date(2024,6,26));
